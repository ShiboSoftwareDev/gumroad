  ...
  private
    ...
    def validate_sending_limit_for_sellers
      ...
      if audience_members_count(SENDING_LIMIT + 1) > SENDING_LIMIT && user.sales_cents_total < MINIMUM_SALES_CENTS_VALUE
        errors.add(:base, "<a href='/help/article/269-balance-page.html'>Sorry, you cannot send out more than #{SENDING_LIMIT} emails until you have $#{MINIMUM_SALES_CENTS_VALUE / 100} in total earnings.</a>".html_safe)
      end
    end
