    ...
    context "when seller is sending more than 100 emails" do
      context "when seller has less than $100 sales" do
        it "returns minimum sales error" do
          ...
          expect(@installment.errors.full_messages.to_sentence).to eq("<a href='/help/article/269-balance-page.html'>Sorry, you cannot send out more than 2 emails until you have $100 in total earnings.</a>")
        end
